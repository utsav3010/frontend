          ...
          <Container fluid className='mt-5'>
            <Row>
              <div className='col-md-5 shadow ms-5 p-4 mt-5'>
                <img src="https://i.pinimg.com/originals/50/78/a0/5078a05eb1b6847d93383eaa4c0ed500.gif" alt="" className='img-fluid' />
              </div>

              <div className='col-md-6 shadow p-4 mt-5'>
                <h1 className='text-center mt-5'> <ins>About</ins> </h1>
